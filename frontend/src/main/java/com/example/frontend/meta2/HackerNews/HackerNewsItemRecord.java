/*
 * package com.example.frontend.meta2.HackerNews;
 * 
 * import java.util.List;
 * 
 * import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
 * 
 * // This indicates that any properties not bound in this type should be
 * ignored.
 * 
 ...
 * String type, // The type of item. One of "job", "story", "comment", "poll",
 * or "pollopt".
 ...
 * String parent, // The comment's parent: either another comment or the
 * relevant story.
 ...
 * Integer descendants // In the case of stories or polls, the total comment
 * count.
 * ) {
 * }
 */